...
// On small screens the rail becomes a hamburger drawer. Collapse state persists; the streak comes from
// the server (the same `streaks` table /achievements reads), so it can never disagree with it.
