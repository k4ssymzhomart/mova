...
// ProgressClient — the patient's longitudinal read. Deliberately chart-free: progress is communicated
// through large editorial numerals, plain-language deltas, and lucide trend glyphs — no systematic
// graphs. Data comes from the same engine the coach uses, sourced server-side from Supabase (the real
// source of truth) so history is consistent across devices.
