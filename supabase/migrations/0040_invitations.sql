-- 0040_invitations.sql (0029 on feature/exercise-screen-rebuild; renumbered past the applied 0036, not applied)
-- Before applying, review against 0036: invitations_read trusts app.is_clinic_member, the same over-broad branch
-- 0036 removed from care_plan_overrides_read (any patient in the clinic could read its invitations); and
-- accept_invitation re-homes an existing patient's profile and patients row without their session rows.
